...
function run() {
  ...
  mongoose.connect('mongodb://localhost/backbone_mongo');
...
//Wrapper methods for the generators
function generateCompanies(count) {
    var generateCompany = generators.Company();   //Alias to the company generator
...
//Make sure to call the run method to kickoff the seeding.
